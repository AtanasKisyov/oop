...
def zero_test():
    print(System.register_power_hardware("HDD", 200, 200))
    print(System.register_heavy_hardware("SSD", 400, 400))
    print(System.analyze())
    print(System.register_light_software("HDD", "Test", 0, 10))
    print(System.register_express_software("HDD", "Test2", 100, 100))
    print(System.register_express_software("HDD", "Test3", 50, 100))
    print(System.register_light_software("SSD", "Windows", 20, 50))
    print(System.register_express_software("SSD", "Linux", 50, 100))
    print(System.register_light_software("SSD", "Unix", 20, 50))
    print(System.analyze())
    print()
